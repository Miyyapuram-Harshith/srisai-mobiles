...
CREATE TABLE products (
  ...
  stock INTEGER DEFAULT 0, -- stockCount
  category TEXT NOT NULL, -- deviceType ('brand_new', 'used', etc.)
...
-- 12. Create Wishlist Table (Polymorphic: UUID referencing product or accessory)
...
-- 13. Create Cart Items Table (Polymorphic: UUID referencing product or accessory)
...
-- 14. Create Compare Items Table (Polymorphic: UUID referencing product or accessory)
...
('u0000000-0000-0000-0000-000000000001', 'superadmin@srisaimobiles.com', 'super_admin', 'Sri Sai Super Admin', '+91 8688303048'),
('u0000000-0000-0000-0000-000000000002', 'admin@srisaimobiles.com', 'admin', 'Store Admin', '+91 8688303048');

-- Banners Seeds
INSERT INTO banners (id, title, subtitle, image_url, active, priority, redirect_link, slideshow_timer) VALUES
('b0000000-0000-0000-0000-000000000001', 'iPhone 15 Pro Max', 'Titanium Design & A17 Pro Chip', 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?q=80&w=1200&auto=format&fit=crop', true, 1, 'product/p0000000-0000-0000-0000-000000000001', 5),
('b0000000-0000-0000-0000-000000000002', 'Samsung Galaxy AI is Here', 'Experience Galaxy S24 Ultra', 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?q=80&w=1200&auto=format&fit=crop', true, 2, 'product/p0000000-0000-0000-0000-000000000005', 5),
...
-- Products Seeds (15 Premium Mobile Products)
...
('s0000000-0000-0000-0000-000000000001', 'Sri Sai Mobiles', 'H.No. 4-2-120, Near Tower Circle, Jagtial, Telangana - 505327', '+91 8688303048', '8688303048', 'Welcome to Sri Sai Mobiles Jagtial! How can we assist you today?');
...
('f0000000-0000-0000-0000-000000000001', 'p0000000-0000-0000-0000-000000000001', 15.0, 5, 1, '2026-07-06T10:00:00Z', '2026-07-07T22:00:00Z', true),
('f0000000-0000-0000-0000-000000000002', 'p0000000-0000-0000-0000-000000000005', 20.0, 3, 0, '2026-07-06T10:00:00Z', '2026-07-07T22:00:00Z', true);
...
-- 1. Policies for Categories (All Selectable, admin insert/update/delete)
...
-- 2. Policies for Users (Selectable by self/authenticated, write by self/authenticated)
...
-- 3. Policies for Products (All Selectable, admin write)
...
-- 4. Policies for Accessories (All Selectable, admin write)
...
-- 5. Policies for Inventory (Admin view and write)
...
-- 6. Policies for Banners (All Selectable, admin write)
...
-- 7. Policies for Orders (Select/Insert by everyone, update/delete by admin)
...
-- 8. Policies for Dashboard Analytics (All Selectable, admin write)
...
-- 9. Policies for Settings (All Selectable, admin write)
...
-- 10. Policies for Flash Sales (All Selectable, admin write)
...
-- 11. Policies for Addresses (Select/insert/delete by everyone for prototype simplicity)
CREATE POLICY "Allow all addresses" ON addresses FOR ALL USING (true);

-- 12. Policies for Wishlist (Select/insert/delete by everyone for prototype simplicity)
CREATE POLICY "Allow all wishlist" ON wishlist FOR ALL USING (true);

-- 13. Policies for Cart Items (Select/insert/delete by everyone for prototype simplicity)
CREATE POLICY "Allow all cart_items" ON cart_items FOR ALL USING (true);

-- 14. Policies for Compare Items (Select/insert/delete by everyone for prototype simplicity)
